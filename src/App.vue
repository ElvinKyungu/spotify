            ...
            <div class="flex justify-between items-center px-12 py-3">
                <section>
                    <header class="">
                        <div class="flex items-center space-x-4">
                            <button class="py-2 px-4 rounded-3xl text-base bg-white font-semibold text-black">
                                S'abonner
                            </button>
                            <button class="py-2 px-4 rounded-3xl text-base bg-black font-semibold text-white">
                                Installer l'appli
                            </button>
                        </div>
                    </header>
                ...
                <div class="flex items-center">
                    <img 
                      ...
                      src="https://media.licdn.com/dms/image/D4D03AQEGZl3U2jfGPA/profile-displayphoto-shrink_800_800/0/1686566977757?e=1694649600&v=beta&t=pN2SUsI12VFlaytl34YFOkwWd7ZMWNYo2BBzMtJYEiU"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Elvin Kyungu</div>
